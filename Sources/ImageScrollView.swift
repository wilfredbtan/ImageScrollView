...
//         Make sure views have already layout with precise frame
    ...
    @objc open func display(image: UIImage) {
        zoomView?.image?.fixImageOrientation()
...
//        if UIDevice.current.orientation.isLandscape ||  imageScrollViewDelegate!.landScapeV  {
//            imageScrollViewDelegate!.landScapeV = true
//
//            imageSize = size
...
//        else {
        ...
        print("Zoomscale: \(zoomScale)")
            ...
            case .begining:
                ...
                print("Beginning offset \(contentOffset)")
            case .center:
                print("Center offset")
...
//        }
    ...
    @objc func changeOrientationNotification() {
        ...
        print("\(UIDevice.current.orientation.isLandscape) printed at ImageScrollView changeOrientationNotification")
//        if UIDevice.current.orientation.isLandscape  ||  imageScrollViewDelegate!.landScapeV || UIDevice.current.orientation.isFlat  {
//            imageScrollViewDelegate!.landScapeV = true
//            return
//        }
